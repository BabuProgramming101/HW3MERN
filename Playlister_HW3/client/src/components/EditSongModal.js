...
export default class EditSongModal extends Component {
    ...
    handleConfirmEditSong = () => {
        ...
        let index = this.props.songIndex;
        this.props.updateSongCallback(index, newSongData);
    }
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <input id="edit-song-modal-title-textfield" className='modal-textfield' type="text" defaultValue={this.state.title} onChange={this.handleUpdateTitle} />
